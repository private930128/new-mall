...
import ltd.newbee.mall.util.PageInfo;
...
public interface BaseMapper<T> {
    ...
    List<T> select(@Param("isLike") Boolean isLike, @Param("wheres") T wheres,
            @Param("selects") List<String> selects,
            @Param("orderColumns") List<String> orderColumns, @Param("isAsc") Boolean isAsc,
    ...
    List<T> select(@Param("wheres") T wheres, @Param("orderColumns") List<String> orderColumns,
    ...
    List<T> select(@Param("wheres") T wheres, @Param("orderColumns") List<String> orderColumns,
            @Param("isAsc") Boolean isAsc, @Param("pageInfo") PageInfo pageInfo);
